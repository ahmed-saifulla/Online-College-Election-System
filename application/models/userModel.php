...
class UserModel extends CI_Model{
	...
	var $column_order = array('id','username','status','CreatedOn','Status'); //set column field database for datatable orderable
	var $column_search = array('id', 'username'); //set column field database for datatable searchable.
