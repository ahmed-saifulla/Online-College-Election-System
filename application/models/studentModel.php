...
class StudentModel extends CI_Model{
	...
	var $column_order = array('usn','s_name','dob','dept','sem','email'); //set column field database for datatable orderable
	var $column_search = array('usn', 's_name'); //set column field database for datatable searchable.
	var $order = array('usn' => 'desc'); // default order 
