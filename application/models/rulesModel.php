...
class rulesModel extends CI_Model{
	...
	var $column_order = array('Id','rule'); //set column field database for datatable orderable
	var $column_search = array('Id', 'rule'); //set column field database for datatable searchable.
