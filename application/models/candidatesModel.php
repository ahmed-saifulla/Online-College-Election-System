...
class candidatesModel extends CI_Model{
	...
	var $column_order = array('usn','c_name','dob','dept','sem','email'); //set column field database for datatable orderable
	var $column_search = array('usn', 'c_name'); //set column field database for datatable searchable.
